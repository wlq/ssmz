...
<body class="easyui-layout">	
	...
	<div region="center" border="false">
		 <table id="da" class="easyui-datagrid" style="width:600px;height:200px"
            data-options="singleSelect:true,url : 'noticeAction!datagrid.action',">
        <thead>
            <tr>
                <th data-options="field:'cid',checkbox:true"></th>
                <th data-options="field:'csend',width:180">发信人</th>
                <th data-options="field:'cdatei',width:180">通知内容</th>
                <th data-options="field:'csendtime',width:150">发信时间</th>
            </tr>
        </thead>
    </table>
	</div>
