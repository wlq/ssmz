 ...
 */
@Entity
@Table(name = "tempiricalResearch",schema= "")
public class TempiricalResearch implements java.io.Serializable {
	...
	/** default constructor */
	public TempiricalResearch() {
	}

	/** minimal constructor */
	public TempiricalResearch(String cid) {
		this.cid = cid;
	}
